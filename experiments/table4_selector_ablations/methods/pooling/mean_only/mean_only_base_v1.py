"""Clean Mean-Only GS-node pooling ablation.
...
with masked mean pooling and changing the following Linear input 128 -> 64.
"""
...
FULL = _load(
    "stage1_full_pooling_base_for_mean_ablation",
